...
2. The server responds with its SSL/TLS configuration as well as a digital certificate from a trusted certificate authority such as [Let's Encrypt](https://letsencrypt.org)
